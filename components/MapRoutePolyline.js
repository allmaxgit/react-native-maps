...
class MapRoutePolyline extends React.Component {
  render() {
    return (
      <AIRMapRoutePolyline {...this.props} />
    );
  }
}

MapRoutePolyline.propTypes = propTypes;
MapRoutePolyline.defaultProps = defaultProps;

const AIRMapRoutePolyline = requireNativeComponent('AIRMapRoutePolyline', MapRoutePolyline);

module.exports = MapRoutePolyline;
